...
/* harmony import */ var _components_tabs_hover__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/tabs-hover */ "./src/js/components/tabs-hover.js");
/* harmony import */ var _components_tabs_hover__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_tabs_hover__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./src/js/components/tabs-hover.js":
/*!*****************************************!*\
  !*** ./src/js/components/tabs-hover.js ***!
  \*****************************************/
/***/ (() => {
...
for (let i = 0; i < tabBtnDoors.length; i++) {
  tabBtnDoors[i].parentNode.nextElementSibling.querySelector("button").addEventListener("click", () => {
    tabBtnDoors[i].style.cssText = "\n          background-color: var(--light);\n          color: var(--main-black);\n          border: 0.052vw solid var(--main-black);\n      ";
    tabBtnDoors[i].parentNode.nextElementSibling.querySelector("button").style.cssText = "\n          background-color: var(--main-green-dark);\n          color: var(--light);\n          border: 1px solid transparent;\n      ";
  });
}

const tabBtnParquet = document.querySelectorAll(".tabs__nav-item--parquet button");

for (let i = 0; i < tabBtnParquet.length; i++) {
  tabBtnParquet[i].parentNode.previousElementSibling.querySelector("button").addEventListener("click", () => {
    tabBtnParquet[i].style.cssText = "\n          background-color: var(--light);\n          color: var(--main-black);\n          border: 0.052vw solid var(--main-black);\n      ";
    tabBtnParquet[i].parentNode.previousElementSibling.querySelector("button").style.cssText = "\n          background-color: var(--main-green-dark);\n          color: var(--light);\n          border: 1px solid transparent;\n      ";
  });
}
...
const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]("new-products");
